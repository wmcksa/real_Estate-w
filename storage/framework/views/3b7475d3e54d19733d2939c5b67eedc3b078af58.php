    ...
    <div class="text-box">
        ...
        <div class="invest-btns d-flex justify-content-between">
            <button type="button" class="investNow"
                ...
                <a aria-label="Chat on WhatsApp" href="https://wa.me/<?php echo e(Config::get('basic.whatsapp_number')); ?>/?text=urlencodedtext">
                    <img alt="Chat on WhatsApp" width="50" src="<?php echo e(asset('assets/img/1.png')); ?>" />
            </a>
        </div>
...
<?php /**PATH C:\laragon\www\real\resources\views/themes/original/partials/propertyBox.blade.php ENDPATH**/ ?>