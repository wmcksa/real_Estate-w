                ...
                <div class="col-lg-9  col-xl-10">
                    ...
                    <h5 class="card-title m-2 ">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-sm-10">
                                @if($ticket->status == 0)
                                    <span class="custom-badge badge-pill bg-primary">@lang('Open')</span>
                                @elseif($ticket->status == 1)
                                    <span class="custom-badge badge-pill bg-success">@lang('Answered')</span>
                                @elseif($ticket->status == 2)
                                    <span class="custom-badge badge-pill badge-dark">@lang('Customer Reply')</span>
                                @elseif($ticket->status == 3)
                                    <span class="custom-badge badge-pill bg-danger">@lang('Closed')</span>
                                @endif
