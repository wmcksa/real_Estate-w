    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 justify-content-end">
                <a href="{{route('admin.blogCategory')}}" class="btn btn-sm  btn-primary btn-rounded mr-2">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="status" class="custom-switch-checkbox"
                                                       id="status"
                                                       value="0" {{ optional($blogCategoryDetails[$language->id][0]->category)->status == 0 ? 'checked' : '' }}>
