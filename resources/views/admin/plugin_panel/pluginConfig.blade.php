                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="{{ route('admin.tawk.control') }}" class="btn btn-sm btn-primary btn-rounded" target="_blank">@lang('Configuration')</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-6">@lang('Message your customers,they\'ll love you for it')</div>
                                                        <div class="col-md-3"><a href="{{ route('admin.fb.messenger.control') }}" class="btn btn-sm btn-primary btn-rounded" target="_blank">@lang('Configuration')</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="{{ route('admin.google.recaptcha.control') }}" class="btn btn-sm btn-primary btn-rounded" target="_blank">@lang('Configuration')</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="{{ route('admin.google.analytics.control') }}" class="btn btn-sm btn-primary btn-rounded" target="_blank">@lang('Configuration')</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
