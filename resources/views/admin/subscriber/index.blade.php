    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <a href="{{route('admin.subscriber.sendEmail')}}"
               class="btn btn-primary btn-rounded btn-sm mb-3 float-right" >
               @lang('Send Email')
            </a>
            @endif
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                <a href="javascript:void(0)"
                                   ...
                                   class="btn btn-outline-danger btn-sm removeModalBtn" data-toggle="tooltip" title=""
                    ...
                    @empty
                        <tr>
                            <td class="text-center text-na" colspan="9">@lang('No Subscriber Found!')</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
