                    ...
                    @forelse($logs as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Status')">
                                @if($item->status == 0)
                                    <span class="custom-badge badge-pill bg-warning">{{trans('Pending')}}</span>
                                @elseif($item->status == 1)
                                    <span class="custom-badge badge-pill bg-success">{{trans('Approved')}}</span>
                                @elseif($item->status == 2)
                                    <span class="custom-badge badge-pill bg-danger">{{trans('Rejected')}}</span>
                                @endif
                            ...
                            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                                <td data-label="@lang('Action')">
                                    ...
                                    <button
                                        class="edit_button btn-rounded  btn  {{($item->status == 0) ?  'btn-outline-primary' : 'btn-outline-primary'}}  btn-sm "
            ...
            <div class="modal-content ">
                ...
                <form role="form" method="POST" class="actionRoute" action="" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-rounded" data-dismiss="modal">@lang('Close')</button>
